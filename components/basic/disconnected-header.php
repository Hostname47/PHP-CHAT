    ...
    <div id="menu-login-credentials-container">
        ...
        <div class="flex-column">
            ...
            <div class="row-v-flex">
                ...
                <label class="small-label" for="keep-me-connected">Kepp me connected</label>
            </div>
        </div>
        ...
        <div style="margin: 0 4px"></div>
        <form action="" class="flex-form" id="login-form">
            <input type="submit" id="connect" value="Login" class="button-style-1">
        </form>
